...
- Use naming convention: `[purpose]-[component].md`
- Purpose prefixes: `upgrade|refactor|feature|data|infrastructure|process|architecture|design`
- Example: `upgrade-system-command.md`, `feature-auth-module.md`
- File must be valid Markdown with proper front matter structure

If the referred plan file is missing, then create a new file with the appropriate name and structure. If the file already exists, update it with the new content while preserving existing information and versioning appropriately.
